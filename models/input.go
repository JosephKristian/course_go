...
type AccountActivation struct {
	EmailOrPhone     string `json:"email_or_phone" form:"email_or_phone" binding:"required"`
	VerificationCode int    `json:"verification_code" form:"verification_code" binding:"required"`
}
